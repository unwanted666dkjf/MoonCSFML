#ifndef MOON_CSFML_GRAPHICS_MOON_CIRCLE_SHAPE_H
#define MOON_CSFML_GRAPHICS_MOON_CIRCLE_SHAPE_H
...
#define moon_CircleShape_DefaultRadius 		(0)

#define moon_CircleShape_DefaultPointCount 	(30)


struct MOON_CSFML_API moon_CircleShape;


/**
 * Specialized shape representing a circle.
 */
typedef struct moon_CircleShape moon_CircleShape;


/**
 * Creates default circle.
 */
MOON_CSFML_API moon_CircleShape*
...
/**
 * Creates circle shape from given parameters.
 */
MOON_CSFML_API moon_CircleShape*
...
/**
 * Destroys circle shape.
 */
MOON_CSFML_API void
moon_CircleShape_destroy(moon_CircleShape* self);

/**
 * Draws a circle to the RenderWindow.
 */
MOON_CSFML_API void
