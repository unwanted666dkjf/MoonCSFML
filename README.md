...
The goal was to make C game development a less painful experience.

When creating this library, I took into account the experience of 
creating the previous one: [SSW_SFML3](https://github.com/unwanted666dkjf/SSW_SFML3).

Why 'Moon'?
I developed this library mostly at night.


## Notes

SFML 2.6.2 was chosen as binding target, even 
though [SFML3.1.0](https://github.com/SFML/SFML/releases/tag/3.1.0) is the stable version at the time of writing.
...
I'll contribute bug fixes and update the library as needed.

I also plan to rewrite SFML 2.6.2 slightly. I don't promise anything, 
but if the need arises, I will definitely do it.

As they used to say, “If it works, don’t touch it.”.
...
Also, any link here may become invalid at any time through no fault of my own.

This library does not have a module for working with networking. 
This is done on purpose so as not to overcomplicate the project.


## Building

You can download built version of library from 'release' page or build it yourself.
...
But, of course, as always, the best tutorial is the source code.
...
cmake --build . or cmake --build . --config Release
```
After build you can launch executable and see if it works.
